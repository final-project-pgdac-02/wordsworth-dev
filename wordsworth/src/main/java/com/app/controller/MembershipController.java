...
public class MembershipController {
	...
	public ResponseEntity<?> setDiscountStatus(@RequestBody Membership membership) {
		return new ResponseEntity<>(
				membershipService.updateDiscountStatus(membership.getId(), membership.isDiscountIsActive()),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<?> setDiscountPercent(@RequestBody Membership membership) {
		return new ResponseEntity<>(
				membershipService.updateMembershipDiscount(membership.getId(), membership.getDiscount()),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<?> setMembershipCost(@RequestBody Membership membership) {
		return new ResponseEntity<>(
				membershipService.updateMembershipCost(membership.getId(), membership.getMembershipCost()),
				HttpStatus.OK);
	}
